# go-wordpress
[![GoDoc](https://godoc.org/github.com/ka2n/go-wordpress?status.svg)](https://godoc.org/github.com/robbiet480/go-wordpress)
...
```bash
go get github.com/ka2n/go-wordpress
```
...
cd $GOPATH/src/github.com/ka2n/go-wordpress
go test
```
